        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSkillLevel = table.Column<int>(type: "int", nullable: false),
                    LastLessonDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    JoinDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CurrentRepertoire = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TargetPieces = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentGoals = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinutesPerWeekCommitment = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationMinutes = table.Column<DateTime>(type: "datetime2", nullable: false),
